...
#    Updated: 2025/07/23 13:44:55 by jesuserr         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME = ft_ls
SRCS = main.c parser.c print_errors.c merge_sort.c merge_sort_comp.c \
	   print_list.c list_files.c print_long_format.c
...
NORM = $(addprefix $(PATH_SRCS), $(SRCS)) srcs/ft_ls.h
GREEN = "\033[0;92m"
RED = "\033[0;91m"
BLUE = "\033[0;94m"
NC = "\033[0m"
